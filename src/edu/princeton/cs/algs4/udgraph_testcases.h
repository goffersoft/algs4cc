 ...
 *
 ******************************************************************************/
#ifndef __UDGRAPH_TESTCASES_H__
#define __UDGRAPH_TESTCASES_H__
...
class udgraph_testcase1 : public testcase {
    public :
        udgraph_testcase1(const string& name = "udgraph - all tests") :
                           testcase(name) {
            add_test(bind(&udgraph_testcase1::test1, this),
                     "constructor-(num_v) test");
            add_test(bind(&udgraph_testcase1::test2, this),
                     "constructor-(cin) test");
            add_test(bind(&udgraph_testcase1::test3, this),
                     "constructor-(cin) exception test");
            add_test(bind(&udgraph_testcase1::test4, this),
                     "degree method test");
            add_test(bind(&udgraph_testcase1::test5, this),
                     "min_degree method test");
            add_test(bind(&udgraph_testcase1::test6, this),
                     "max_degree method test");
            add_test(bind(&udgraph_testcase1::test7, this),
                     "avg_degree method test");
            add_test(bind(&udgraph_testcase1::test8, this),
                     "has_vertex method test");
            add_test(bind(&udgraph_testcase1::test9, this),
                     "has_edge method test");
            add_test(bind(&udgraph_testcase1::test9_1, this),
                     "has_edge(udedge_base) method test");
            add_test(bind(&udgraph_testcase1::test10, this),
                     "has_edge method exception test");
            add_test(bind(&udgraph_testcase1::test10_1, this),
                     "has_edge(udedge_base) method exception test");
            add_test(bind(&udgraph_testcase1::test11, this),
                     "has_edge method exception test");
            add_test(bind(&udgraph_testcase1::test11_1, this),
                     "has_edge(udedge_base) method exception test");
            add_test(bind(&udgraph_testcase1::test12, this),
                     "add_edge(v,w) method test");
            add_test(bind(&udgraph_testcase1::test13, this),
                     "add_edge(v,w) method exception test");
            add_test(bind(&udgraph_testcase1::test14, this),
                     "add_edge(v,w) method exception test");
            add_test(bind(&udgraph_testcase1::test15, this),
                     "add_edge(udedge_base) method test");
            add_test(bind(&udgraph_testcase1::test16, this),
                     "add_edge(udedge_base) method exception test");
            add_test(bind(&udgraph_testcase1::test17, this),
                     "add_edge(udedge_base) method exception test");
            add_test(bind(&udgraph_testcase1::test18, this),
                     "get_edges(all vertices) method test");
            add_test(bind(&udgraph_testcase1::test19, this),
                     "get_edges(single vertex) method test");
            add_test(bind(&udgraph_testcase1::test20, this),
                     "get_edges(range of vertices) method test");
            add_test(bind(&udgraph_testcase1::test21, this),
                     "get_edges(single vertex) method exception test");
            add_test(bind(&udgraph_testcase1::test22, this),
                     "get_edges(vertex range) method exception test");
            add_test(bind(&udgraph_testcase1::test23, this),
                     "get_edges(vertex range) method exception test");
        }
