 ...
 *
 ******************************************************************************/
#ifndef __DFS_TESTCASES_H__
#define __DFS_TESTCASES_H__
...
class dfs_testcase1 : public testcase {
    public :
        dfs_testcase1(const string& name =
                         "dfs - udgraph - all tests") :
                           testcase(name) {
            add_test(bind(&dfs_testcase1::test1, this),
                     "has_path method - test");
            add_test(bind(&dfs_testcase1::test2, this),
                     "count method - test");
            add_test(bind(&dfs_testcase1::test3, this),
                     "set_start_vertex method test");
            add_test(bind(&dfs_testcase1::test4, this),
                     "set_start_vertex method exception test");
            add_test(bind(&dfs_testcase1::test5, this),
                     "recompute method test");
            add_test(bind(&dfs_testcase1::test6, this),
                     "get_graph method test");
            add_test(bind(&dfs_testcase1::test7, this),
...
class dfs_testcase2 : public testcase {
    public :
        dfs_testcase2(const string& name =
                        "dfs - digraph - all tests") :
                           testcase(name) {
            add_test(bind(&dfs_testcase2::test1, this),
                     "has_path method - test");
            add_test(bind(&dfs_testcase2::test2, this),
                     "count method - test");
            add_test(bind(&dfs_testcase2::test3, this),
                     "set_start_vertex method test");
            add_test(bind(&dfs_testcase2::test4, this),
                     "set_start_vertex method exception test");
            add_test(bind(&dfs_testcase2::test5, this),
                     "recompute method test");
            add_test(bind(&dfs_testcase2::test6, this),
                     "get_graph method test");
            add_test(bind(&dfs_testcase2::test7, this),
                     "set_graph method test");
        }
...
class dfs_testcase3 : public testcase {
    public :
        dfs_testcase3(
                   const string& name =
                      "dfs - weighted_udgraph - all tests") :
                           testcase(name) {
            add_test(bind(&dfs_testcase3::test1, this),
                     "has_path method - test");
            add_test(bind(&dfs_testcase3::test2, this),
                     "count method - test");
            add_test(bind(&dfs_testcase3::test3, this),
                     "set_start_vertex method test");
            add_test(bind(&dfs_testcase3::test4, this),
                     "set_start_vertex method exception test");
            add_test(bind(&dfs_testcase3::test5, this),
                     "recompute method test");
            add_test(bind(&dfs_testcase3::test6, this),
                     "get_graph method test");
            add_test(bind(&dfs_testcase3::test7, this),
                     "set_graph method test");
        }
...
class dfs_testcase4 : public testcase {
    public :
        dfs_testcase4(
                   const string& name =
                       "dfs - weighted_digraph - all tests") :
                           testcase(name) {
            add_test(bind(&dfs_testcase4::test1, this),
                     "has_path method - test");
            add_test(bind(&dfs_testcase4::test2, this),
                     "count method - test");
            add_test(bind(&dfs_testcase4::test3, this),
                     "set_start_vertex method test");
            add_test(bind(&dfs_testcase4::test4, this),
                     "set_start_vertex method exception test");
            add_test(bind(&dfs_testcase4::test5, this),
                     "recompute method test");
            add_test(bind(&dfs_testcase4::test6, this),
                     "get_graph method test");
            add_test(bind(&dfs_testcase4::test7, this),
                     "set_graph method test");
        }
...
class dfs_testcase5 : public testcase {
    public :
        dfs_testcase5(
               const string& name =
                    "dfs - flow_network - all tests") :
                           testcase(name) {
            add_test(bind(&dfs_testcase5::test1, this),
                     "has_path method - test");
            add_test(bind(&dfs_testcase5::test2, this),
                     "count method - test");
            add_test(bind(&dfs_testcase5::test3, this),
                     "set_start_vertex method test");
            add_test(bind(&dfs_testcase5::test4, this),
                     "set_start_vertex method exception test");
            add_test(bind(&dfs_testcase5::test5, this),
                     "recompute method test");
            add_test(bind(&dfs_testcase5::test6, this),
                     "get_graph method test");
            add_test(bind(&dfs_testcase5::test7, this),
                     "set_graph method test");
        }
